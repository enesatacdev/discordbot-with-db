...
namespace Template.Utilities
{
    public class Images
    {
        ...
        {
            string url = "https://cdn.pixabay.com/photo/2017/08/04/18/38/skull-2580981_960_720.jpg";
            ...
            banner = DrawTextToImage(banner, $"{user.Username}#{user.Discriminator} Sunucuya Katıldı", $"Sunucudaki sıran : {user.Guild.MemberCount}");
        ...
        private async Task<Image> FetchImageAsync(string url)
        {
            ...
            {
                var backupResponse = await client.GetAsync("https://cdn.pixabay.com/photo/2017/08/04/18/38/skull-2580981_960_720.jpg");
